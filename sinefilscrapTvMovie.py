...
#tvseries
for page in range(2,pagesTvseries+2):
    countPage=0
    ...
    print('Page %d/%d is done. %d/%d tvseries'%(page-1,pagesTvseries,countPage,tvseriesCount))
    sleep(randint(2,3))
...
totalCounts = pd.DataFrame({'tvSeriesCount':tvseriesCount,'filmCount':filmCount,'Totals':tvseriesCount+filmCount},index=[0])
